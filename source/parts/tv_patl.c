/*
 * parts/tv_patl.c -- shared body; LCP_ORG links it in tvanim.o,
 * LCP_STX in the 0xdece object at 0x13204, before tv_boul.
...
#else   /* STX: link #-38 -- a 10-short point buffer at -34, the
           pattern selection is four independent ifs, and the second
           polyline point is (x + 3, y). */
