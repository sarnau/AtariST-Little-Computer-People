...
OBJS=$(find . -maxdepth 1 -name "*.o" ! -name "gemstart.o" ! -name "main.o" ! -name "gemstart_dk.o" \
    ...
    ! -name "vdilib.o" ! -name "vdilib_a.o" ! -name "psg_asm.o" ! -name "blkcp_a.o" | sort | sed 's|^\./||')
LIST=$(echo "gemstart.o main.o $OBJS psg_asm.o blkcp_a.o vdilib.o vdilib_a.o vdibind.a aesbind.a osbind.o gemlib.a gemlib.a" | tr -s ' \n' ',,')
